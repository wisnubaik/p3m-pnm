...
export default async function PkmEksternalPage() {
  const pkm = await getPkm();
  ...
  return (
    <main className="min-h-screen bg-white">
      ...
      <section className="pt-32 pb-16 bg-gradient-to-br from-blue-950 via-blue-800 to-blue-600">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-blue-200 max-w-xl mx-auto text-lg">
            Daftar PKM eksternal sivitas akademika Politeknik Negeri Madiun
          </p>
        </div>
      </section>
      ...
      <section className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        {pkm.length === 0 ? (
          <p className="text-center text-slate-400">Belum ada data PKM.</p>
        ) : (
